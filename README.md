...
1. 먼저 Kaggle에서 데이터셋을 다운받는다.<br>
[https://www.kaggle.com/datasets/lantian773030/pokemonclassification](https://www.kaggle.com/datasets/lantian773030/pokemonclassification)
2. PokemonData 폴더안에 포켓몬의 이름으로된 폴더안에 샘플사진들을 넣는다.(아래참조, 포켓몬종류는 150개가 기본설정)<br>
